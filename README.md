# 🧪 Soft-Agar-Colony-Counter - Count Colonies with Ease
...
## ✅ Features
- **Live Threshold Tuning**: Adjust settings in real-time for accurate counting.
- **Manual Annotation**: Make adjustments manually for precision.
- **CSV Export**: Easily export your results for further analysis.
- **User-Friendly Interface**: Designed for users without programming knowledge.
- **Privacy**: Runs on your local machine, keeping your data safe.

## 💻 System Requirements
To run Soft-Agar-Colony-Counter, ensure your system meets the following requirements:
...
1. **Open the Application**: Double-click the application icon to launch it in your default web browser.
2. **Upload Your Images**: Use the upload feature to load your soft agar images for analysis.
3. **Adjust Threshold Settings**: Use the live tuning feature to adjust the threshold and see immediate changes.
4. **Manually Annotate if Needed**: If there are any discrepancies, use manual annotation to correct them.
5. **Export Results**: After confirming the count, export your data as a CSV file using the export function.
...
A: The software supports JPG, PNG, and TIFF formats.
